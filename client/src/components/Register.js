...
import { Container, Box, Typography, TextField, Button, Paper, Grid, CircularProgress, Alert } from '@mui/material';
      ...
      <Paper elevation={6} sx={{ p: 4, mt: 10, borderRadius: 5, boxShadow: 10 }}>
        ...
        <Box component="form" onSubmit={handleSubmit} sx={{ mt: 3 }}>
          ...
          <Box sx={{ mt: 2, textAlign: 'center' }}>
            ...
            >
              {loading ? <CircularProgress size={24} color="secondary" /> : 'Create Account'}
            </Button>
          </Box>
